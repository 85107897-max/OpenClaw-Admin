...
INSERT OR IGNORE INTO migration_history (version, description, status) 
VALUES ('010_database_design_completion', '数据库设计完成迁移 - 包含 sessions, 2FA, WAF, CI/CD 扫描表', 'applied');
